...
8.  **Survey coverage based percentages (based on the most recent survey)**
...
### Denominator assessment {#sec-denom-assessment}
...
The second part is to compare results from the different methods - both at the national and sub-national levels.![](images/1-dqa_dhis2_comparison.png)
